...
const Breadcrumb = () => {
    return (<nav className="inline-block pt-[10px] mb-[10px]" aria-label="Breadcrumb">
        <ol className="inline-flex w-full items-center text-xs space-x-1 rtl:space-x-reverse text-dark-gray md:space-x-2">
            ...
            <li className="hidden sm:block">
                <div className="flex items-center">
                    ...
                    <a href="#" className="text-xs text-gray-700 ms-1 hover:text-blue-600">
...
const LeftSection = () => {
    return (<aside className="z-10 hidden h-full bg-white w-[190px] md:block">
        ...
        <div className="mb-2xs text-2xs">
            ...
            />
            <button
                className="block border ml-[5px] px-[9px] h-[26px] rounded-[3px] border-light-dark-gray bg-gray">
                OK
            </button>
        </div>
        <div className="mb-2xs">
...
const RightSection = () => {
    return (<aside className="hidden h-full bg-white w-[190px] text- lg:block lg:pt-0">
        <div className="mb-2xs">
...
const ProductSection = ({children}) => {
    ...
    const childrenWithProps = React.Children.map(children, (child) => React.cloneElement(child, {toggleProduct}));
    ...
    return (<main className="flex h-full flex-1 flex-col lg:p-4">
            ...
            <div className="flex h-full items-center justify-between text-xs px-2xs">
                ...
                <div className="flex items-center py-[2px]">
                    ...
                    <button className="mr-1 h-[17px] w-[17px]" onClick={handleList}>
                        <List className={cn(`w-[17px] h-[17px]`, {"stroke-green": toggleProduct,})}/>
                    </button>
                    <button className="ml-1 h-[17px] w-[17px]" onClick={handleGallery}>
                        <Gallery className={cn(`w-[17px] h-[17px]`, {"stroke-green": !toggleProduct})}/>
                    </button>
                </div>
            </div>
        </div>
        {/* Trading Type */}
        <div
            className={cn(`w-full h-full relative ${toggleProduct ? "flex-col flex-nowrap mt-1" : "search-list flex flex-wrap mt-1"}`)}>
            {childrenWithProps}
        </div>
        {/* Product Item*/}
        <Pagination/>
        ...
        <div className="px-2xs text-xs">
            ...
            <form action="" className="mt-4 w-full flex flex-col sm:flex-row">
                ...
                <button type="submit"
                    ...
                    <span
                        className="relative bg-green hover:bg-light-green w-full sm:rounded-l-none rounded-md inline-block border-2 border-green px-3 py-3 text-xs font-semibold uppercase text-white group-active:text-opacity-75">
...
const ProductItem = ({toggleProduct}) => {
    return (<div
        className={cn(`${toggleProduct ? "w-full flex px-2xs pt-1.3 pb-2 xs:bg-green/5 bg-white" : "basis-1/2 xs:basis-1/3 md:basis-1/3 xl:basis-1/4 p-3 hover:border-gray"}  border-white border transition-colors duration-200`)}>
        <div className={cn(`relative ${toggleProduct ? "flex w-full" : "h-[298px]"} rounded-md `)}>
            <div className={cn(`relative bg-white ${toggleProduct ? "h-full xl:w-1/3" : "h-1/2 w-full"}`)}>
                <a href="#" className={cn(`w-full min-w-[7.813rem] h-[7.813rem] relative xl:h-full block`)}>
                    <Image
                        src={Spaghetti}
                        fill
                        sizes="100%"
            ...
            <div className={cn(`${toggleProduct ? "w-full block px-2 lg:px-3" : "w-full"}`)}>
                <h2 className="overflow-hidden text-ellipsis mt-2xs">
                    <a href="#"
                       className={cn(`capitalize hover:text-green hover:underline ${toggleProduct ? "font-semibold text-xs" : "text-xs line-clamp-2"}`)}>
            ...
            {/* product description */}
            {toggleProduct && (<div className="hidden w-2/5 sm:block">
