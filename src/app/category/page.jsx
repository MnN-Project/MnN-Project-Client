...
const ProductSection = ({children}) => {
    ...
    return (
        <main className="flex h-full flex-1 flex-col lg:p-4">
            ...
            <div className="border border-t-0 border-b-0 top refine search-guide border-dark-gray">
                <div className="relative overflow-hidden pt-[15px] pr-[55px]">
                    <div className="flex flex-wrap">
                        <a href="#" className="inline-block border text-xs capitalize rounded-[3px] px-2xs ml-2xs h-[28px] leading-[28px] mb-[15px] border-dark-gray">
                            Ring Die
                        </a>
                        <a href="#" className="inline-block border text-xs capitalize rounded-[3px] px-2xs ml-2xs h-[28px] leading-[28px] mb-[15px] border-dark-gray">
            ...
            {/* Trading Type */}
            <div className={cn(`w-full h-full relative ${toggleProduct ? "flex-col flex-nowrap mt-1" : "search-list flex flex-wrap mt-1"}`)}>
                {childrenWithProps}
            </div>
            {/* Product Item*/}
...
const ProductItem = ({toggleProduct}) => {
    return (
        <div className={cn(`${toggleProduct ? "w-full flex px-2xs pt-1.3 pb-2 xs:bg-green/5 bg-white" : "basis-1/2 xs:basis-1/3 md:basis-1/3 xl:basis-1/4 p-3 hover:border-gray"}  border-white border transition-colors duration-200`)}>
            <div className={cn(`relative ${toggleProduct ? "flex w-full" : "h-[298px]"} rounded-md `)}>
                <div className={cn(`relative bg-white ${toggleProduct ? "h-full xl:w-1/3" : "h-1/2 w-full"}`)}>
                    ...
                    <a href="#" className="absolute top-0 right-0 mt-2 mr-2 flex h-7 w-7 items-center justify-center rounded-full group bg-gray">
                ...
                <div className={cn(`${toggleProduct ? "w-full block px-2 lg:px-3" : "w-full"}`)}>
                    <h2 className="overflow-hidden text-ellipsis mt-2xs">
                        <a href="#" className={cn(`capitalize hover:text-green hover:underline ${toggleProduct ? "font-semibold text-xs" : "text-xs line-clamp-2"}`)}>
                    ...
                    {!toggleProduct && (
                        <a href="#" className="mt-2 inline-flex items-center justify-center rounded-md text-xs text-white transition-colors bg-green h-[26px] w-[126px] hover:bg-light-green lg:mt-5">
