            ...
            <Container className="">
                <section className="h-full mt-s">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="capitalize text-green text-center font-semibold text-lg">Post your request</h2>
                    ...
                    <form action="#" className="mt-2 max-w-4xl mx-auto">
                        <div className="mt-2">
                            <div className="form wrapper space-y-2 sm:p-8 md:space-y-4">
                                <h2 className="text-sm hidden sm:block">Drop more information as much as
                                    possible so you can get the precise product that you are looking for</h2>
                                <div className="bg-white p-4 lg:p-8 rounded-md border border-gray">
                                    <div className="space-y-4">
                                        <div className="space-y-4">
                                            ...
                                            <div>
                                                <label htmlFor="Category"
                                                       className="block text-sm font-medium text-gray-900 sr-only"> Category </label>
                                                <select name="" id=""
                                        ...
                                        <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-2">
                                            ...
                                            <div className="space-y-4">
                                                <div>
                                                    <label htmlFor="Tonnes"
                                                           className="block text-sm font-medium text-gray-900 sr-only"> Tonnes </label>
                                                    <select name="" id=""
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                <label htmlFor="OrderNotes"
                                                       className="block text-sm font-medium text-gray-700 sr-only"> Order
                                                    notes</label>
                                                <textarea
                                                    id="OrderNotes"
                                            ...
                                            <div className="flex items-center justify-center w-full">
                                                <label htmlFor="dropzone-file"
                                                    ...
                                                    <div
                                                        ...
                                                        <svg className="w-8 h-8 mb-4 text-dark-gray" aria-hidden="true"
                                                        ...
                                                        <p className="mb-2 text-sm text-dark-gray"><span
                                                            className="font-semibold">Click to upload</span> or drag and
                                                            drop</p>
                                                        <p className="text-xs text-dark-gray">SVG, PNG,
                                ...
                                <div className="bg-white p-4 lg:p-8 rounded-md border border-gray">
                                    <div className="space-y-4">
                                        <div className="sm:flex items-center w-full sm:space-x-4">
                                            ...
                                            <div className="basis-2/3">
                                                <label htmlFor="Shipping"
                                                       className="block text-sm font-medium text-gray-900 sr-only"> Shipping </label>
                                                <select name="" id=""
                                                        className="w-full rounded-lg border-gray-300 text-sm text-dark focus:ring-green focus:border-green">
                                        ...
                                        <div className="sm:flex items-center w-full sm:space-x-4">
                                            ...
                                            <div className="basis-2/3">
                                                <label htmlFor="Destination"
                                                       className="block text-sm font-medium text-gray-900 sr-only"> Destination </label>
                                                <select name="" id=""
                                                        className="w-full rounded-lg border-gray-300 text-sm text-dark focus:ring-green focus:border-green">
                                        ...
                                        <div className="sm:flex items-center w-full sm:space-x-4">
                                            ...
                                            <div className="basis-2/3">
                                                <label htmlFor="Time Lead"
                                                       className="block text-sm font-medium text-gray-900 sr-only"> Time
                                                    Lead </label>
                                                <select name="" id=""
                                                        className="w-full rounded-lg border-gray-300 text-sm text-dark focus:ring-green focus:border-green">
                                        ...
                                        <div className="sm:flex items-center w-full sm:space-x-4">
                                            ...
                                            <div className="basis-2/3">
                                                <label htmlFor="Means of Payment"
                                                       className="block text-sm font-medium text-gray-900 sr-only"> Means
                                                    of Payment </label>
                                                <select name="" id=""
                                                        className="w-full rounded-lg border-gray-300 text-sm text-dark focus:ring-green focus:border-green">
                                        ...
                                        <div className="sm:flex items-center w-full sm:space-x-4">
                                            ...
                                            <button type="submit"
                                                    className="w-full sm:basis-2/3 py-2 flex items-center justify-center text-white bg-green hover:bg-light-green rounded-md">Submit
                                            </button>
                                        </div>
                                    </div>
                                </div>
