      ...
      <Container className="p-5 bg-white shadow-sm overflow-hidden ">
        ...
        <div className="cards">
          <div className="singleCard">
            <div className="iconTop"><HiArrowsExpand/></div>
            ...
            <div className="textBelow">
              ...
              tempora ullam laboriosam ea mollitia officiis voluptas, hic totam
              rem dolorum voluptatibus nihil labore voluptate sunt quia.
              Praesentium, fugit enim?
            </div>
          </div>
          <div className="singleCard">
            <div className="iconTop"><HiBookOpen/></div>
            <h3 className="text-sm sm:text-2xl text-green py-2 mb-2">
              Our Vision
            </h3>
            <div className="textBelow">
          ...
          <div className="singleCard">
            <div className="iconTop"><HiBriefcase/></div>
            <h3 className="text-sm sm:text-2xl text-green py-2 mb-2">
              Our Mission
            </h3>
            <div className="textBelow">
          ...
          <div className="singleCard">
            <div className="iconTop"><HiColorSwatch/></div>
            <h3 className="text-sm sm:text-2xl text-green py-2 mb-2">
              Our Mission
            </h3>
            <div className="textBelow">
