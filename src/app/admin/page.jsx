            ...
            <AdminContainer>
                ...
                <main>
                    <div className="fixed top-0 right-0 left-0 pointer-events-none w-auto h-[3px] opacity-0 bg-green"
                         style={{
                             backgroundSize: '180.662%',
                             transform: 'scaleX(0.638317)',
                    ...
                    <div className="">
                        <div className="mb-8 flex flex-col justify-between md:flex-row md:items-center">
                            <div
                                className="ltablet:max-w-full flex max-w-[425px] flex-col items-center gap-4 text-center md:flex-row md:text-left lg:max-w-full">
                                <div
                                    className="relative inline-flex shrink-0 items-center justify-center outline-none h-16 w-16 rounded-full">
                                    <div
                                        className="rounded-full flex h-full w-full items-center justify-center overflow-hidden text-center transition-all duration-300">
                                        <Image
                                            ...
                                            className="h-16 w-16 max-h-full max-w-full object-cover shadow-sm dark:border-transparent"
                                            width={64} height={64} alt="avatar"/>
                                    </div>
                                </div>
                                <div>
                                    <h2 className="font-heading text-lg font-light leading-tight text-dark">
                                        <span>Welcome back, Godwin</span>
                                    </h2>
                                    <p className="font-alt text-base font-normal leading-normal">
                                        <span
                                            className="text-dark-gray">Happy to see you again on your dashboard. </span>
                                    </p>
                                </div>
                            </div>
                            <div className="mt-4 flex items-center justify-center gap-2 md:mt-0 md:justify-start">
                                <button type="button"
                                        className="h-9 rounded px-5 py-2 text-sm bg-white text-dark-gray border border-gray hover:bg-light-gray transition-colors">
                                    <span>View Reports</span>
                                </button>
                                <button type="button"
                                        className="h-9 px-5 py-2 rounded bg-light-green hover:bg-green btn-focus text-white text-sm">
                        ...
                        <div className="grid grid-cols-12 gap-4">
                            <LineChart id={chart1.id} data={chart1.data} color={chart1.color} label={chart1.label}
                                       value={chart1.value}>
                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img"
                                     className="icon text-danger/50 h-7 w-7" viewBox="0 0 256 256">
                                    <g fill="currentColor">
                                        <path d="m216 64l-12.16 66.86A16 16 0 0 1 188.1 144H62.55L48 64Z"
                                              opacity=".2"/>
                                        <path
                            ...
                            {/*chart 1*/}
                            <LineChart id={chart2.id} data={chart2.data} color={chart2.color} label={chart2.label}
                                       value={chart2.value}>
                                <svg
                            ...
                            {/*chart 2*/}
                            <LineChart id={chart3.id} data={chart3.data} color={chart3.color} label={chart3.label}
                                       value={chart3.value}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                            ...
                            {/*chart 3*/}
                            <LineChart id={chart4.id} data={chart4.data} color={chart4.color} label={chart4.label}
                                       value={chart4.value}>
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
                                ...
                                <div
                                    ...
                                    <div className="flex gap-8 w-full">
                                        <div>
                                            ...
                                            <p className="text-green font-sans text-lg font-medium">
                                                $75,689
                                            </p>
                                        </div>
                                        <div>
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="font-alt text-xs font-normal">
                                                       <span className="text-dark-gray">
                                                          ...
                                                          adipiscing elit. Bonum integritas corporis.
                                                       </span>
                                                </p>
                                            </div>
                                            <div className="flex-1">
