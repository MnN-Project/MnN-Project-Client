...
const GridWrapper = ({ children, className, label, large }) => {
  return (
    <div className={cn('mt-5 grid grid-cols-12 gap-y-1.5 sm:gap-x-5 sm:gap-y-0 w-full', className)}>
      <div
      ...
      <div className={`col-span-12 sm:col-span-8 ${large ? 'lg:col-span-8' : 'lg:col-span-4'}`}>
        {children}
      </div>
      {/* End Col */}
    </div>
            ...
            <div className="py-6 sm:py-8">
              ...
              <div className="grid gap-1.5 grid-cols-12 sm:gap-x-5 sm:gap-y-0">
                <div className="col-span-12 xl:col-span-3 sm:col-span-4 2xl:col-span-2">
                  <Label className="inline-block mt-2.5 text-sm text-dark-gray">Avatar</Label>
                </div>
                {/* End Col */}
            ...
            <div className="py-6 sm:py-8 border-t border-gray">
              ...
              <GridWrapper label="new password">
                ...
                <div className="flex items-center gap-2 mt-5">
                  ...
                  <Link className="text-sm text-green font-semibold" href="#">
            ...
            <div className="py-6 sm:py-8 border-t border-gray">
              <div className="inline-flex items-center gap-2">
                <GridWrapper label=" Two-Step Verification">
                  {/* Alert */}
                  <div className="p-4 text-green rounded-lg bg-green/10" role="alert">
                    <div className="flex">
                      <svg
                  ...
                  <div className="grid gap-5 sm:grid-cols-2 2xl:grid-cols-3">
                    ...
                    <SessionCard current device="Chrome OS">
                      <li className="flex justify-between items-center">
                        <span className="text-xs uppercase text-dark-gray">Location:</span>
                        <span className="text-sm font-medium">Nigeria</span>
                      </li>

                      <li className="flex justify-between items-center">
                        <span className="text-xs uppercase text-dark-gray">Device:</span>
                        <span className="text-sm font-medium">Safari - iOS</span>
                      </li>
                      <li className="flex justify-between items-center">
                        <span className="text-xs uppercase text-dark-gray">IP address:</span>
                        <span className="text-sm font-medium">129.562.028.172</span>
                      </li>
                      <li className="flex justify-between items-center">
                        <span className="text-xs uppercase text-dark-gray">Recent activity:</span>
              ...
              <div className="flex items-center gap-2">
                <GridWrapper label="Danger Zone">
                  ...
                  <p className="text-sm text-dark-gray mt-3">
                    ...
                    <Link className="text-green font-semibold" href="#">
                      Learn more
                    </Link>
                  </p>
                </GridWrapper>
