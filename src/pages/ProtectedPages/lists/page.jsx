...
const Admin = () => {
  ...
  return (
    <AdminContainer>
      <main>
        <div
          className="fixed top-0 right-0 left-0 pointer-events-none w-auto h-[3px] opacity-0 bg-green"
          style={{
            ...
            <div className="ltablet:max-w-full flex max-w-[425px] flex-col items-center gap-4 text-center md:flex-row md:text-left lg:max-w-full">
              ...
              <div>
                <h2 className="font-heading text-lg font-light leading-tight text-dark">
                  <span>{'Welcome back Ernest '}</span>
                </h2>

                <p className="font-alt text-base font-normal leading-normal">
                  <span className="text-dark-gray">Happy to see you again on your dashboard. </span>
                </p>
              </div>
            </div>
