    ...
    <>
              ...
              <div className="flex">
                ...
                <div className="w-1/3">
                  <div className="text-sm h-[181px] px-2xs">
                    <h3 className="block overflow-hidden text-ellipsis whitespace-nowrap text-sm font-bold py-2xs">
                      Agriculture Machinery
                    </h3>
                    <a href="/categories" className="capitalize pb-2xs">
                      Agricultural Machinery
                    </a>
                    <a href="#" className="capitalize pb-2xs">
                ...
                <div className="w-1/3 px-2xs">
                  <div className="text-sm px-2xs">
                    ...
                    <a href="#" className="capitalize pb-2xs">
                      Machinery For Foods Beverages and Ce...
                    </a>
                    <a href="#" className="capitalize pb-2xs">
                    ...
                    <a href="#" className="capitalize pb-2xs">
                      Machinery For Garment,Shoes, A...
                    </a>
                    <a href="#" className="capitalize pb-2xs">
                      Crushing and Culling Machine
                    </a>
                  </div>
                </div>
              </div>
              <a href="#" className="text-sm font-medium mb-2xs text-blue">
                More Categories
              </a>
            </div>
          </div>
      ...
      >
        <a href="#" className="block whitespace-nowrap text-sm group py-1.3">
          <span
            className={cn("text-blue py-3xs transition-colors duration-150")}
          >
            More Categories
          </span>
        </a>
