...
const Aside = ({ children }) => {
  return (
    <aside className="flex-auto basis-1/4 relative">
      <div className="pl-s">
        ...
        <div className="mt-xs">
          ...
          <a
            href="#"
            className="align-middle h-9 px-xs cursor-pointer text-green border border-green rounded-[3px] mt-1.3 w-full text-sm flex items-center justify-center hover:text-white hover:bg-green transition-colors delay-100 ease-linear"
          >
