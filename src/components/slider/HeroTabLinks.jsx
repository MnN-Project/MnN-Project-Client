...
const HeroTabLinks = ({ firstChild, src, bodyText, headingText }) => {
  return (
    <li
      className={cn(
        `basis-1/4 group transition-all ease-in-out delay-200`,
        {
    ...
    >
      <div className="bg-light-gray h-full relative overflow-hidden">
        <div
          className={cn(
            `absolute w-[100px] h-[80px] bottom-0 right-0 translate-y-0`,
            {
        ...
        >
          <Image src={src} width={150} height={80} priority={true} alt="" />
        </div>
        {firstChild && (
