...
const HeroSlider = () => {
  return (
    <div className="flex-1 flex flex-col justify-between min-h-ful lg:basis-3/4">
      <div className="basis-3/4">
        <ImageSlide className={`min-h-44 w-full h-full relative`} />
      </div>
      {/* Slider */}
      <div className="mt-2xs basis-1/4 hidden md:block">
        <ul className="flex justify-between h-full gap-2xs">
          <HeroTabLinks
            firstChild
