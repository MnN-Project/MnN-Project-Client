...
const Navigation = () => {
    return (
      <nav className="flex-1 flex items-start min-w-0">
                ...
                <div className="flex items-center justify-between h-8.5">
                  <div className="relative h-full border-r-2 border-green">
                    <div className="relative h-full">
                      ...
                      {/* search dropdown */}
                      <div className="rounded-lg hidden shadow-md bg-white text-dark-gray text-base leading-relaxed whitespace-normal outline-none transition-all duration-300 z-50 absolute top-full left-0 min-w-full w-34 ">
        ...
        {/* second nav */}
        <div className="shrink-0 flex items-center -mx-3.7">
         <DropdownTooltip className="ml-10.5 group">
            ...
            <Tooltip className={cn(`max-w-min whitespace-nowrap hidden`, 'group-hover:block')}>
