  ...
  const [dropdowns, setDropdowns] = useState([
    {
      ...
      isOpen: false,
      label: "Overview",
      subItems: ["Overview", "Order Details"],
    },
    {
      id: 2,
      isOpen: false,
      label: "Products",
      subItems: ["Overview", "Products Details", "Add Product"],
    },
    {
      id: 3,
      isOpen: false,
      label: "Business",
      subItems: ["Overview", "Payouts"],
    },
  ...
  const handleDropdownReset = useCallback(
    (event) => {
      if (!event.target.closest(".menu-item")) {
        setDropdowns(
          dropdowns.map((dropdown) => ({ ...dropdown, isOpen: false }))
        );
        setActiveId(null);
      }
    },
    ...
    <>
      ...
      >
        <div className="flex flex-col items-start lg:flex-row">
          <div
            className={cn(
              `flex justify-start items-center w-full lg:w-1/4 mb-3.7 lg:mb-0 lg:justify-start`
            )}
          >
                          ...
                          {item.subItems ? (
                            <div className="mt-1">
                              ...
                              <button
                                ...
                                className={`py-2 font-medium px-3 w-full text-start text-sm hs-dropdown-toggle flex gap-2 rounded-md hover:bg-light-gray ${
