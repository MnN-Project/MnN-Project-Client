    ...
    return item ? (
        <div className="relative w-1/2 border border-t-0 border-l-0 border-light-gray sm:w-1/4">
            <div className="relative block pt-m px-m pb-xs group">
                <div
                    className="h-12 overflow-hidden leading-6 transition-colors delay-150 ease-in-out text-u-base z-2 text-wrap text-dark group-hover:text-green">
                    {text}
                </div>
                <div className="-mt-6 text-right">
                    <div className="inline-block overflow-hidden w-30 h-30">
                        <div className="relative w-full overflow-hidden text-center pt-full">
                            <Image
                                src={image}
                                className="absolute right-0 bottom-0 object-cover object-left-bottom transition-transform delay-150 ease-in-out group-hover:scale-105"
                                width={400}
                                height={400}
                                alt=""
                            />
        ...
        <div className="w-1/3 px-2xs mb-s group md:w-[16.6%]">
            <a href="#" className="block h-full w-full group-hover:text-green">
                ...
                <div
                    className="block text-center text-sm capitalize transition-colors delay-150 ease-in-out group-hover:text-green">
                    {text}
                </div>
            </a>
        </div>
