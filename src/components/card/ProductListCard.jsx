...
const ProductListCard = ({ image, text, item }) => {
    return item ? (
      <div
        className="relative border border-light-gray border-l-0 border-t-0 w-1/4"
      >
          ...
          <div className="text-right -mt-6">
            <div className="w-30 h-30 inline-block overflow-hidden">
              <div className="relative w-full text-center pt-full overflow-hidden ">
                <Image
                  src={image}
                  className="transition-transform object-cover object-center ease-in-out delay-150 absolute top-0 right-0 bottom-0 left-0 group-hover:scale-105"
                  width={400}
                  height={400}
                  alt=""
                />
      ...
      <div className="px-2xs mb-s w-[16.6%] group">
